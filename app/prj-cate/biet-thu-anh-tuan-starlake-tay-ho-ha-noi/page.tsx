...
export const metadata: Metadata = {
  title: "Dự án tại Starlake, Tây Hồ - VIET HOME",
  description:
    "Công trình biệt thự tại Starlake, Tây Hồ, Hà Nội – triển khai hệ thống lọc nước tổng kết hợp nước nóng trung tâm.",
};

const gallery = [
  "/images/duandathuchien/starlake-tay-ho-1.png",
  "/images/duandathuchien/starlake-tay-ho-2.jpg",
  "/images/duandathuchien/starlake-tay-ho-3.jpg",
];

export default function ProjectStarlakePage() {
  return (
    <main className="bg-white">
      <Breadcrumb
        items={[
          ...
          { label: 'Dự Án Tại Starlake, Tây Hồ, Hà Nội' },
        ]}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 text-white">
            <div className="animate-fadeInUp">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                DỰ ÁN TẠI STARLAKE, TÂY HỒ, HÀ NỘI
              </h1>
              <p className="text-lg md:text-xl max-w-2xl text-gray-100">
                Công trình biệt thự tại Starlake, Tây Hồ – triển khai hệ thống lọc nước tổng kết hợp nước nóng trung tâm
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại Starlake, Tây Hồ, Hà Nội được triển khai hệ thống lọc nước tổng kết hợp máy nước nóng trung tâm Heatpump, mang đến nguồn nước sạch cho toàn bộ ngôi nhà và nguồn nước nóng ổn định, tiết kiệm năng lượng. Giải pháp cao cấp phù hợp với không gian sống đẳng cấp tại khu đô thị Starlake.
            </p>
          </div>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: "300ms" }}>
            ...
            <ul className="space-y-5 text-gray-600">
              {[
                "Hệ thống lọc nước tổng đa tầng",
                "Heat Pump công nghệ tiết kiệm điện",
                "Cung cấp nước nóng ổn định 24/7",
                "Bảo vệ thiết bị & nâng cao chất lượng nước",
              ].map((item, i) => (
                <li
                  key={i}
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Starlake, Tây Hồ, Hà Nội" },
                { label: "Loại công trình", value: "Biệt thự" },
                { label: "Hạng mục", value: "Hệ thống lọc nước & nước nóng trung tâm" },
