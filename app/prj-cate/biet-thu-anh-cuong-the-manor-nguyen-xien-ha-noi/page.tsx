...
export const metadata: Metadata = {
  title: "Dự án tại The Manor, Nguyễn Xiển - VIET HOME",
  description:
    "Công trình biệt thự tại KĐT The Manor, Nguyễn Xiển, Hà Nội – triển khai hệ thống lọc nước tổng.",
};

const gallery = [
  "/images/duandathuchien/the-manor-nguyen-xien-1.jpg",
  "/images/duandathuchien/the-manor-nguyen-xien-2.jpg",
  "/images/duandathuchien/the-manor-nguyen-xien-3.jpg",
];

export default function ProjectManorPage() {
  return (
    <main className="bg-white">
      <Breadcrumb
        items={[
          ...
          { label: 'Dự Án Tại The Manor, Nguyễn Xiển, Hà Nội' },
        ]}
      />
      ...
      <div className="relative h-[500px] overflow-hidden">
        <Image
          src={gallery[0]}
          alt="Dự án The Manor, Nguyễn Xiển"
          fill
          ...
          <div className="max-w-7xl mx-auto px-4 text-white">
            <div className="animate-fadeInUp">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                DỰ ÁN TẠI THE MANOR, NGUYỄN XIỂN, HÀ NỘI
              </h1>
              <p className="text-lg md:text-xl max-w-2xl text-gray-100">
                Công trình biệt thự tại KĐT The Manor – triển khai hệ thống lọc nước tổng cao cấp
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại KĐT The Manor, Nguyễn Xiển, Hà Nội được triển khai hệ thống lọc nước tổng cao cấp, mang đến nguồn nước sạch tinh khiết cho toàn bộ ngôi nhà. Hệ thống lọc tổng giúp loại bỏ tạp chất, kim loại nặng và vi khuẩn, bảo vệ sức khỏe gia đình và các thiết bị sử dụng nước.
            </p>
          </div>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: "300ms" }}>
            ...
            <ul className="space-y-5 text-gray-600">
              {[
                ...
                "Loại bỏ tạp chất, kim loại nặng, vi khuẩn",
                "Cung cấp nước sạch cho toàn bộ ngôi nhà",
                "Bảo vệ thiết bị gia dụng & đường ống",
              ].map((item, i) => (
                <li
                  key={i}
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Nguyễn Xiển, Hà Nội" },
                { label: "Loại công trình", value: "Biệt thự" },
                { label: "Hạng mục", value: "Hệ thống lọc nước tổng" },
