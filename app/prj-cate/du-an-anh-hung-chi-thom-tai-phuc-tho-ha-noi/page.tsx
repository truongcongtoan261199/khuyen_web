...
export const metadata: Metadata = {
  title: "Dự án tại Phúc Thọ, Hà Nội - VIET HOME",
  description:
    "Công trình biệt thự tại Phúc Thọ, Hà Nội – triển khai hệ thống lọc nước tổng kết hợp Hệ thống máy nước nóng trung tâm Heatpump 300L.",
};

const gallery = [
  "/images/duandathuchien/phuc-tho-ha-noi-1.jpg",
  "/images/duandathuchien/phuc-tho-ha-noi-22.png",
  "/images/duandathuchien/phuc-tho-ha-noi-33.png",
  "/images/duandathuchien/phuc-tho-ha-noi-44.png",
];
    ...
    <main className="bg-white">
      <Breadcrumb
        items={[
          ...
          { label: 'Dự Án Tại Phúc Thọ, Hà Nội' },
        ]}
      />
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại Phúc Thọ, Hà Nội được triển khai hệ thống lọc nước tổng kết hợp máy nước nóng trung tâm Heatpump 300L, mang đến nguồn nước sạch cho toàn bộ ngôi nhà và nguồn nước nóng ổn định, tiết kiệm năng lượng. Giải pháp giúp nâng cao chất lượng sinh hoạt, bảo vệ thiết bị sử dụng nước và đáp ứng nhu cầu tiện nghi của gia chủ.
            </p>
          </div>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: "300ms" }}>
            ...
            <ul className="space-y-5 text-gray-600">
              {[
                ...
                "Heat Pump 300L công nghệ tiết kiệm điện",
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Phúc Thọ, Hà Nội" },
