...
export const metadata: Metadata = {
  title: "Dự án tại KĐT Nam An Khánh, Hoài Đức, Hà Nội - VIET HOME",
  description:
    "Công trình biệt thự tại KĐT Nam An Khánh, Hoài Đức, Hà Nội – triển khai hệ thống nước nóng trung tâm.",
};

const gallery = [
  "/images/duandathuchien/an-khanh-hoai-duc-hanoi-1.jpg",
  "/images/duandathuchien/an-khanh-hoai-duc-hanoi-2.jpg",
  "/images/duandathuchien/an-khanh-hoai-duc-hanoi-3.jpg",
];

export default function ProjectAnKhanhPage() {
  return (
    <main className="bg-white">
      <Breadcrumb
        items={[
          ...
          { label: 'Dự Án Tại KĐT Nam An Khánh, Hoài Đức, Hà Nội' },
        ]}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 text-white">
            <div className="animate-fadeInUp">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                DỰ ÁN TẠI KĐT NAM AN KHÁNH, HOÀI ĐỨC, HÀ NỘI
              </h1>
              <p className="text-lg md:text-xl max-w-2xl text-gray-100">
                Công trình biệt thự tại KĐT Nam An Khánh – triển khai hệ thống nước nóng trung tâm hiện đại
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại KĐT Nam An Khánh, Hoài Đức, Hà Nội được triển khai với hệ thống nước nóng trung tâm hiện đại, đáp ứng nhu cầu sử dụng nước nóng ổn định cho toàn bộ ngôi nhà. Giải pháp này mang đến sự tiện nghi tối ưu, tiết kiệm năng lượng và phù hợp với không gian sống cao cấp.
            </p>
          </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Hoài Đức, Hà Nội" },
