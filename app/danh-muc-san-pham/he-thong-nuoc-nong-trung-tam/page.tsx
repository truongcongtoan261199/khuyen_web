...
const products = [
  ...
  },
  {
    ...
    description: "Thương hiệu nước Thái Lan với công nghệ cao cấp, thiết kế hiện đại, phù hợp với khí hậu Việt Nam.",
  ...
  },
  {
    ...
    description: "Một trong những thương hiệu thế giới về thiết bị nước nóng, được thành lập tại San Francisco từ năm 1925. Hiện nay Rheem có mặt tại hơn 80 quốc gia và là một trong những hãng tiên phong về công nghệ máy nước nóng trung tâm Heat Pump.",
