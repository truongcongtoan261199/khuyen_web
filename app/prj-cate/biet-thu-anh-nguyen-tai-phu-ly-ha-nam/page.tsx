...
export const metadata: Metadata = {
  title: "Dự án tại Phủ Lý, Hà Nam - VIET HOME",
  description:
    "Công trình biệt thự KĐT Lam Hạ, Phủ Lý, Hà Nam – triển khai hệ thống lọc nước tổng kết hợp nước nóng trung tâm.",
};

const gallery = [
  "/images/duandathuchien/phu-ly-ha-nam-1.jpg",
  "/images/duandathuchien/phu-ly-ha-nam-2.png",
];

export default function ProjectPhuLyPage() {
  return (
          ...
          <div className="max-w-7xl mx-auto px-4 text-white">
            <div className="animate-fadeInUp">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                DỰ ÁN TẠI PHỦ LÝ, HÀ NAM
              </h1>
              <p className="text-lg md:text-xl max-w-2xl text-gray-100">
                Công trình biệt thự KĐT Lam Hạ, Phủ Lý, Hà Nam – triển khai hệ thống lọc nước tổng kết hợp hệ thống máy nước nóng trung tâm
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại KĐT Lam Hạ, Phủ Lý, Hà Nam được triển khai hệ thống lọc nước tổng kết hợp máy nước nóng trung tâm Heatpump, mang đến nguồn nước sạch cho toàn bộ ngôi nhà và nguồn nước nóng ổn định, tiết kiệm năng lượng. Giải pháp giúp nâng cao chất lượng sinh hoạt, bảo vệ thiết bị sử dụng nước và đáp ứng nhu cầu tiện nghi của gia chủ.
            </p>
          </div>
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Phủ Lý, Hà Nam" },
