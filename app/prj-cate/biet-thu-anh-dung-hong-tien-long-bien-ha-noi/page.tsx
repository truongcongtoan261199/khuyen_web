...
export const metadata: Metadata = {
  title: "Dự án tại Hồng Tiến, Long Biên, Hà Nội - VIET HOME",
  description:
    "Công trình biệt thự tại Hồng Tiến, Long Biên, Hà Nội – triển khai toàn bộ giải pháp lọc nước & nước nóng.",
};

const gallery = [
  "/images/duandathuchien/hong-tien-long-bien-1.png",
  "/images/duandathuchien/hong-tien-long-bien-2.jpg",
];

export default function ProjectHongTienPage() {
  return (
    <main className="bg-white">
      <Breadcrumb
        items={[
          ...
          { label: 'Dự Án Tại Hồng Tiến, Long Biên, Hà Nội' },
        ]}
      />
          ...
          <div className="max-w-7xl mx-auto px-4 text-white">
            <div className="animate-fadeInUp">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                DỰ ÁN TẠI HỒNG TIẾN, LONG BIÊN, HÀ NỘI
              </h1>
              <p className="text-lg md:text-xl max-w-2xl text-gray-100">
                Công trình biệt thự tại Hồng Tiến, Long Biên – triển khai toàn bộ giải pháp lọc nước và nước nóng trung tâm
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-16">
          ...
          <div className="animate-fadeInUp">
            ...
            <p className="text-gray-600 leading-relaxed text-[17px]">
              Dự án biệt thự tại Hồng Tiến, Long Biên, Hà Nội được triển khai toàn bộ giải pháp lọc nước tổng kết hợp hệ thống nước nóng trung tâm. Giải pháp toàn diện này mang đến nguồn nước sạch tinh khiết cho toàn bộ ngôi nhà cùng nguồn nước nóng ổn định, tiết kiệm năng lượng, đáp ứng mọi nhu cầu sinh hoạt của gia đình.
            </p>
          </div>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: "300ms" }}>
            ...
            <ul className="space-y-5 text-gray-600">
              {[
                ...
                "Cung cấp nước sạch & nước nóng ổn định",
                "Giải pháp toàn diện cho biệt thự",
              ].map((item, i) => (
                <li
                  key={i}
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-6 text-sm">
              {[
                { label: "Địa điểm", value: "Hồng Tiến, Long Biên, Hà Nội" },
                { label: "Loại công trình", value: "Biệt thự" },
                { label: "Hạng mục", value: "Toàn bộ giải pháp" },
