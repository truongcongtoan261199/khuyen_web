...
const products = [
  {
    ...
    description: "Hệ thống lọc nước tổng Việt Nam với đa dạng các cấp lọc, đa dạng công suất và vật liệu lọc phù hợp với nhiều nguồn nước khác nhau tại Việt Nam...",
  ...
  },
  {
    ...
    img: "/images/san-pham/loc-tu-truong.png",
    imgWidth: 800,
    imgHeight: 800,
    priceRange: "Chi tiết sản phẩm",
  ...
  },
  {
    ...
    description: "Clack là thương hiệu của Mỹ trong lĩnh vực giải pháp lọc nước tổng, nổi tiếng toàn cầu với độ bền vượt trội, khả năng xử lý nước mạnh mẽ và độ ổn định...",
